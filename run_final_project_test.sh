...
#SBATCH --output=logs/ER_final_project_test_%j.out  # Standard output file (%j will be replaced by the job ID)
#SBATCH --error=logs/ER_final_project_test_%j.err   # Standard error file
